  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  2a:	8d 04 9d a4 0b 00 00 	lea    0xba4(,%ebx,4),%eax
  31:	53                   	push   %ebx
  for (i = 0; i < NUM_THREAD; i++) {
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb c8 08 00 00       	mov    $0x8c8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 98 0b 00 00       	mov    %eax,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 98 0b 00 00       	mov    0xb98,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 822:	00 00 00 
    if(p->s.size >= nunits){
