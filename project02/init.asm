...
main(void)
{
  ...
  11:	53                   	push   %ebx
  12:	51                   	push   %ecx
  printf(1, "이거 돌아가는거임? init.c\n");
  13:	83 ec 08             	sub    $0x8,%esp
  16:	68 58 08 00 00       	push   $0x858
  1b:	6a 01                	push   $0x1
  1d:	e8 ce 04 00 00       	call   4f0 <printf>
  int pid, wpid;
  ...
  bb:	68 a9 08 00 00       	push   $0x8a9
  c0:	e8 d6 02 00 00       	call   39b <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 ac 08 00 00       	push   $0x8ac
  cc:	6a 01                	push   $0x1
  ...
  d9:	6a 01                	push   $0x1
  db:	6a 01                	push   $0x1
  dd:	68 7b 08 00 00       	push   $0x87b
  e2:	e8 c4 02 00 00       	call   3ab <mknod>
    open("console", O_RDWR);
  e7:	58                   	pop    %eax
  e8:	5a                   	pop    %edx
  e9:	6a 02                	push   $0x2
  eb:	68 7b 08 00 00       	push   $0x87b
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 d4 08 00 00 	movzbl 0x8d4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb cb 08 00 00       	mov    $0x8cb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 88 0b 00 00       	mov    0xb88,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 ...
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 842:	00 00 00 
    if(p->s.size >= nunits){
